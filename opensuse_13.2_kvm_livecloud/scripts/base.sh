...
rpm --import http://mirror.bit.edu.cn/opensuse/distribution/13.2/repo/oss/gpg-pubkey-307e3d54-4be01a65.asc
rpm --import http://mirror.bit.edu.cn/opensuse/distribution/13.2/repo/oss/gpg-pubkey-3dbdc284-53674dd4.asc
