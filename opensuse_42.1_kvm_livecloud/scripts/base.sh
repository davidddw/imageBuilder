...
zypper ar http://mirror.bit.edu.cn/opensuse/distribution/leap/42.1/repo/oss/ opensuse-42.1-oss
zypper ar http://mirror.bit.edu.cn/opensuse/distribution/leap/42.1/repo/non-oss/ opensuse-42.1-non-oss
zypper refresh
